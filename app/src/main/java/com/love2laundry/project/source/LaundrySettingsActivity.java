...
public class LaundrySettingsActivity extends Navigation implements MyPreferencesAdapter.Modifier {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!config.isConnected(this)) {
            config.buildDialog(LaundrySettingsActivity.this,"",country).show();
        }else {
                ...
                public void onClick(View view) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            String url = server + sharedPreferencesCountry.getString("apiPreferencesUpdate", null);
