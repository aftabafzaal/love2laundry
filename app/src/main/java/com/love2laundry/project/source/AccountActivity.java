...
public class AccountActivity extends Navigation {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!config.isConnected(this)) {
            config.buildDialog(AccountActivity.this,"home",country).show();
        }else {
            ...
            Log.e("shared ",sharedPreferencesCountry.getString("addressType",null));
            ...
            try {
                ...
                postCode.setHint(sharedPreferencesCountry.getString("addressType",null));
            ...
            updateButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    {
                        Toast.makeText(getApplicationContext(),
                                "Please enter "+sharedPreferencesCountry.getString("addressType",null)+".",
                                Toast.LENGTH_LONG).show();
