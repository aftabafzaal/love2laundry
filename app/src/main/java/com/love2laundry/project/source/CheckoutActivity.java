...
public class CheckoutActivity extends Navigation
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!config.isConnected(this)) {
            config.buildDialog(CheckoutActivity.this,"",country).show();
            ...
            discountHeading = (TextView) findViewById(R.id.discount_text);
            ...
            deviceId = sharedPreferencesCountry.getString("deviceId", null);

            currencySymbol = config.getCurrencySymbol(countryCode);
            ...
            TextView postCodeFieldText = (TextView) findViewById(R.id.post_code_text);
            postCodeFieldText.setHint(sharedPreferencesCountry.getString("addressType",null));
            ...
            deliveryDateButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (pickUpTime == null) {
                        ...
                        String q="?pick_date="+pickUpDate+"&device_id="+deviceId+"&type=Delivery&date="+pickUpDate+"&pick_time_hour="+pickUpTime.substring(0,1);


                        Log.e("--> ",sharedPreferencesCountry.getString("apiDeliveryDate", null) + "/" + franchise_id+q);

                        intent.putExtra("action", sharedPreferencesCountry.getString("apiDeliveryDate", null) + "/" + franchise_id+q);
                        startActivityForResult(intent, 10);
                    }
                }
            });
            ...
            applyButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (codeField.getText().toString().equals("")) {
                        ...
                        postCode(codeField.getText().toString(), member_id, deviceId);
                    }
            ...
            checkoutButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (!config.isConnected(CheckoutActivity.this)) {
                        ...
                        Toast.makeText(getApplicationContext(), "Please choose delivery time first!", Toast.LENGTH_LONG).show();
                                ...
                                public void onResponse(String response) {
                                    ...
                                    try {
                                        ...
                                        if (result.equals("Success")) {
                                            ...
                                            cartDb.deleteAll(androidId,country);
    ...
    public void applyDiscount()
    {
        ...
        if(validDiscount==true && servicesTotal>minimumOrderAmount) {
            ...
            Log.e("-->",codeString);
            discountHeading.setText("Discount ("+tempArray[2]+")");
    ...
    public void managePreferencesTotal(){
        ...
        try {
            ...
            //Log.e("checkoutPreferences",checkoutPreferencesCopy.toString());
            selectedP="";
