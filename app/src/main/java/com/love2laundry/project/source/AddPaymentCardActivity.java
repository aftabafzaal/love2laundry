...
public class AddPaymentCardActivity extends Navigation {

    EditText name,title,number,cvvCode;
    private String TAG = AddPaymentCardActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!config.isConnected(this)) {
            config.buildDialog(AddPaymentCardActivity.this,"home",country).show();
        }else {
                ...
                public void onClick(View view) {
                    ...
                    } else if(cvvCode.length() < 3  )
                    {
                        ...
                        try {
                            ...
                            RequestQueue queue = Volley.newRequestQueue(AddPaymentCardActivity.this);
                            Log.e(TAG,url);
                                        ...
                                        public void onResponse(String response) {
                                            ...
                                            try {
                                                ...
                                                if(result.equals("Success")) {
                                                    ...
                                                    Intent intent = new Intent(AddPaymentCardActivity.this, PaymentCardsActivity.class);
