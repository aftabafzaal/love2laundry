...
class EditCartAdapter extends RecyclerView.Adapter<EditCartAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        ...
        sharedPreferencesCountry = p.getSharedPreferences("country", MODE_PRIVATE);
        ...
        try {
            ...
            myViewHolder.unitPrice.setText(config.getCurrencySymbol(countryCode)+config.displayPrice(unitPrice));
